    ...
    <div className="bg-white min-h-screen pb-20 font-sans relative overflow-x-hidden">
      <div className="w-full max-w-[1400px] mx-auto px-4 md:px-6 py-2 md:py-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="relative w-full md:w-64">
              ...
              <Input
                ...
                className="pl-10 bg-[#f8f8f8] border-none rounded-none h-10 text-[11px] font-black uppercase tracking-widest focus-visible:ring-0"
              />
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="h-10 rounded-none border-none bg-slate-50 gap-3 px-4 text-[10px] font-black uppercase tracking-widest hover:bg-slate-100 transition-all text-slate-700 active:scale-95">
                  CATEGORY: {category}
                </Button>
              </DropdownMenuTrigger>
                 ...
                 <div className="bg-slate-900 rounded-none p-6 flex items-center justify-between border-2 border-slate-900 transition-all overflow-hidden relative shadow-lg">
                    ...
                    <div className="flex items-center gap-6 relative z-10">
                       <div className="w-14 h-14 bg-white rounded-none flex items-center justify-center text-slate-900 border-2 border-slate-900">
                          <Zap className="h-7 w-7 text-brand-primary fill-brand-primary animate-pulse" />
                       </div>
                       <div>
                    ...
                    <div className="hidden md:flex items-center gap-2 bg-brand-primary px-8 py-3 rounded-none text-white text-[11px] font-black uppercase tracking-widest hover:bg-slate-900 transition-all relative z-10 shadow-lg">
        ...
        {globalLoading && allProducts.length === 0 ? (
          ...
          <div className="text-center py-32 bg-white rounded-none border border-slate-100">
            <div className="w-32 h-32 bg-[#f8f8f8] flex items-center justify-center mx-auto mb-10 rounded-none">
           ...
           <div className="mt-8">
              <a href={settings.ads.adsterra.bannerSixCode} target="_blank" rel="noopener noreferrer" className="block relative group">
                 <div className="bg-[#f8f8f8] rounded-none p-16 text-center hover:bg-white transition-all border-2 border-[#777] shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="inline-block bg-slate-900 text-white px-12 py-5 font-black uppercase text-xl tracking-widest hover:bg-brand-primary transition-all rounded-none shadow-xl active:scale-95">
